...
from fourinsight.engineroom.utils import DrioDataSource, date_start_end
...
class Test_date_start_end:
    def test_start_end_freq(self):
        start = "2020-01-01 00:00"
        end = "2020-01-01 05:00"
        freq = "1H"
        start_out, end_out = date_start_end(start=start, end=end, freq=freq)
    ...
    def test_start_end_period(self):
        ...
        periods = 2
        start_out, end_out = date_start_end(start=start, end=end, periods=periods)
